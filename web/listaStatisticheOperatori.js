	...
	for(var i=0; i<usernameList.length; i++) {
            ...
            newdiv.innerHTML = '<div class="view_item">'+
				...
				'<div class="vi_right">'+
					...
					'<button type="submit" id="btn'+i+'" class="btn" onclick="ModificaDatiOperatore('+i+');">'+'Seleziona'+'</button>'+
					"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+"\u00A0"+
				'</div>'+
			'</div>'+'<br>'+'<br>';
...
promessa.then(usernameList => {
	...
	sessionStorage.setItem('statisticheOperatore', usernameList[posizione]);
	location.href="attivitaEseguiteTotaliAmministratoreSingoloOperatore.html";
