...
function attivitaSvolte() {
	...
	ref.on('value', function(snapshot) {
		...
		snapshot.forEach(function(childSnapshot) {
		  if(childSnapshot.val().operatore == usernameOperatore) {
	...
	if(listaUser.length == 0) {
		...
		var usernameOperatore = sessionStorage.getItem('statisticheOperatore');
		document.getElementById("header").innerHTML = "L'operatore " + usernameOperatore + " non ha inserito nessun utente";
		
	document.getElementById("progressBar").remove();
	document.getElementById("container").style.display = "";
	document.getElementById("box").style.display = "";
	document.getElementById("btnStatisticheAmm").style.display = "none";
	...
	document.getElementById("header").innerHTML = "Numero utenti " + usernameOperatore + ": " + listaUser.length;
